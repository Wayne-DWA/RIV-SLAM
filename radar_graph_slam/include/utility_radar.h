...
public:
    ...
    // static Eigen::Vector3d GravityVec;
    ...
    ParamServer()
    {
        ...
        nh.param<float>("radar_slam/imuAccNoise", imuAccNoise, 0.002);
        nh.param<float>("radar_slam/imuGyrNoise", imuGyrNoise, 0.0001);
        nh.param<float>("radar_slam/imuAccBiasN", imuAccBiasN, 0.0001);
        nh.param<float>("radar_slam/imuGyrBiasN", imuGyrBiasN, 0.000003);
        nh.param<float>("radar_slam/imuGravity", imuGravity, 9.80511);
        // GravityVec << 0, 0, imuGravity;
