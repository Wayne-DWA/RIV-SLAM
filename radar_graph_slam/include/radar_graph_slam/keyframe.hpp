...
public:
  ...
  KeyFrame(const size_t index, const ros::Time& stamp, const Eigen::Isometry3d& odom_scan2scan, double accum_distance, const pcl::PointCloud<PointT>::ConstPtr& cloud, const Eigen::Vector3d& velocity, const Eigen::Isometry3d& riv_pose);
...
public:
  ...
  Eigen::Isometry3d riv_pose;                     // pose estimated by riv optimization
